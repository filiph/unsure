...
class NormalDistribution {
  ...
  NormalDistribution._(this.minimum, this.maximum, {Random? random})
      : assert(
            minimum < maximum,
  ...
  NormalDistribution(double value, double distance, {Random? random})
    : this._(value - distance, value + distance, random: random);
